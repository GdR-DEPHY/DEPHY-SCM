...
levout = np.array(list(range(0,3000,10)) + list(range(3100,int(htop)+1,100)),dtype=float) 

# New temporal grid, from 11:30 UTC, 21 June 1997 to 02:00 UTC, 22 June 1997, 30-min timestep
timeout = np.array(range(0,86400+1800,1800),dtype=float) 
...
newcase.write('BOMEX_REF_SCM_driver.nc')
