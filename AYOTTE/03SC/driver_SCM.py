...
case.read('AYOTTE_03SC_DEF_driver.nc')
...
newcase.set_title("Forcing and initial conditions for AYOTTE-03SC case - SCM-enabled version")
...
newcase.write('AYOTTE_03SC_SCM_driver.nc',verbose=False)
