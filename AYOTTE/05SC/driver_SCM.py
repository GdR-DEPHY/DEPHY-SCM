...
case.read('AYOTTE_05SC_DEF_driver.nc')
...
newcase.set_title("Forcing and initial conditions for AYOTTE-05SC case - SCM-enabled version")
...
newcase.write('AYOTTE_05SC_SCM_driver.nc',verbose=False)
