...
case.read('AYOTTE_24SC_DEF_driver.nc')
...
newcase.set_title("Forcing and initial conditions for AYOTTE-24SC case - SCM-enabled version")
...
newcase.write('AYOTTE_24SC_SCM_driver.nc',verbose=False)
