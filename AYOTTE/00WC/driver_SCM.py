...
case.read('AYOTTE_00WC_DEF_driver.nc')
...
newcase.set_title("Forcing and initial conditions for AYOTTE-00WC case - SCM-enabled version")
...
newcase.write('AYOTTE_00WC_SCM_driver.nc',verbose=False)
