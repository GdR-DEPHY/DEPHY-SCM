...
case.read('AYOTTE_05WC_DEF_driver.nc')
...
newcase.set_title("Forcing and initial conditions for AYOTTE-05WC case - SCM-enabled version")
...
newcase.write('AYOTTE_05WC_SCM_driver.nc',verbose=False)
