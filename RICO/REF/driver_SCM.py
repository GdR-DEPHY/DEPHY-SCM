...
## RICO composite case SCM-enabled - Original definition
...
case.read('RICO_REF_DEF_driver.nc')
...
levout = np.array(range(0,6001,10),dtype=float) 

# New temporal grid, from 00:00 UTC, 16 December 2004 to 00:00 UTC 19 December 2004, 1-hour timestep
timeout = np.arange(0.,(24+1)*3600.,3600.)

# conversion
newcase = case.convert2SCM(time=timeout,lev=levout,levtype='altitude')

# update some attributes
newcase.set_title("Forcing and initial conditions for RICO composite short case - SCM-enabled original version")
newcase.set_script("DEPHY-SCM/RICO/REF/driver_SCM.py")
...
newcase.write('RICO_REF_SCM_driver.nc')
