...
levout = np.array(range(0,4001,10),dtype=np.float64) 
...
newcase.set_title("Forcing and initial conditions for RICO composite short case - SCM-enabled Meso-NH version")
newcase.set_script("DEPHY-SCM/RICO/MESONH/driver_SCM.py")
