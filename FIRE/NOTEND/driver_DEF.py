...
case.set_title("Forcing and initial conditions for FIRE case without tendencies")
case.set_reference("Dyunkerke et al. (2004, QJRMS), Chlond et al. (2004, QJRMS)")
case.set_author("N. Villefranque")
case.set_script("DEPHY-SCM/FIRE/NOTEND/driver_DEF.py")
...
case.write('FIRE_NOTEND_DEF_driver.nc')
