...
case = Case('FIRE/NOTEND')

# read case information in file
case.read('FIRE_NOTEND_DEF_driver.nc')
...
newcase.set_title("Forcing and initial conditions for FIRE case without tendencies - SCM-enabled version")
newcase.set_script("DEPHY-SCM/FIRE/NOTEND/driver_SCM.py")
...
newcase.write('FIRE_NOTEND_SCM_driver.nc')
