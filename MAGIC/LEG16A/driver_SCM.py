...
case.read('MAGIC_LEG16A_DEF_driver.nc')
...
# New temporal grid, from 23:30 UTC, 3 August 2013 to 23:30 UTC, 7 August 2013, 30-min timestep
...
newcase.set_title("Forcing and initial conditions for MAGIC Leg16A case - SCM-enabled version")
newcase.set_script("DEPHY-SCM/MAGIC/LEG16A/driver_SCM.py")
...
newcase.write('MAGIC_LEG16A_SCM_driver.nc')
