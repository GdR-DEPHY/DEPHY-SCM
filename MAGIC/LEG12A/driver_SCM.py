...
## MAGIC Leg12A SCM-enabled case definition
...
case.read('MAGIC_LEG12A_DEF_driver.nc')
...
# New temporal grid, from 17:45 UTC, 8 June 2013 to 5:45 UTC, 13 June 2013, 30-min timestep
timeout = np.array(range(0,388800,1800),dtype=np.float64)

# conversion
newcase = case.convert2SCM(time=timeout,lev=levout,usetemp=True,levtype='altitude')

# update some attributes
newcase.set_title("Forcing and initial conditions for MAGIC Leg12A case - SCM-enabled version")
newcase.set_script("DEPHY-SCM/MAGIC/LEG12A/driver_SCM.py")
...
newcase.write('MAGIC_LEG12A_SCM_driver.nc')
