...
## MAGIC Leg05A SCM-enabled case definition
...
case.read('MAGIC_LEG05A_DEF_driver.nc')
...
# New temporal grid, from 00:00 UTC, 4 Nov 2012 to 12:00 UTC, 8 Nov 2012, 30-min timestep
...
newcase.set_title("Forcing and initial conditions for MAGIC Leg05A case - SCM-enabled version")
newcase.set_script("DEPHY-SCM/MAGIC/LEG05A/driver_SCM.py")
...
newcase.write('MAGIC_LEG05A_SCM_driver.nc')
