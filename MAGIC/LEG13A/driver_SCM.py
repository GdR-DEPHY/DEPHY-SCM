...
case.read('MAGIC_LEG13A_DEF_driver.nc')
...
# New temporal grid, from 17:45 UTC, 22 June 2013 to 06:00 UTC, 27 July 2013, 30-min timestep
timeout = np.array(range(0,389700,1800),dtype=np.float64)
...
newcase.set_script("DEPHY-SCM/MAGIC/LEG13A/driver_SCM.py")
...
newcase.write('MAGIC_LEG13A_SCM_driver.nc')
