...
## MAGIC Leg18A SCM-enabled case definition
...
case.read('MAGIC_LEG18A_DEF_driver.nc')
...
# New temporal grid, from 5:30 UTC, 1 September 2013 to 5:30 UTC, 5 September  2013, 30-min timestep
...
newcase.set_title("Forcing and initial conditions for MAGIC Leg18A case - SCM-enabled version")
newcase.set_script("DEPHY-SCM/MAGIC/LEG18A/driver_SCM.py")
...
newcase.write('MAGIC_LEG18A_SCM_driver.nc')
