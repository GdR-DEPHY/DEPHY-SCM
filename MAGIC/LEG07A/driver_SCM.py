...
## MAGIC Leg07A SCM-enabled case definition
...
case.read('MAGIC_LEG07A_DEF_driver.nc')
...
# New temporal grid, from 17:30 UTC, 1 Dec 2012 to 07:30 UTC, 6 Dec 2012, 30-min timestep
timeout = np.array(range(0,396000,1800),dtype=np.float64)

# conversion
newcase = case.convert2SCM(time=timeout,lev=levout,usetemp=True,levtype='altitude')

# update some attributes
newcase.set_title("Forcing and initial conditions for MAGIC Leg07A case - SCM-enabled version")
newcase.set_script("DEPHY-SCM/MAGIC/LEG07A/driver_SCM.py")
...
newcase.write('MAGIC_LEG07A_SCM_driver.nc')
