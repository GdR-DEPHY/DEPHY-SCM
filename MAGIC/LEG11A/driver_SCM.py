...
## MAGIC Leg11A SCM-enabled case definition
...
case.read('MAGIC_LEG11A_DEF_driver.nc')
...
# New temporal grid, from 18:00 UTC, 26 May 2013 to 5:00 UTC, 30 May 2013, 30-min timestep
timeout = np.array(range(0,298800,1800),dtype=np.float64)

# conversion
newcase = case.convert2SCM(time=timeout,lev=levout,usetemp=True,levtype='altitude')

# update some attributes
newcase.set_title("Forcing and initial conditions for MAGIC Leg11A case - SCM-enabled version")
newcase.set_script("DEPHY-SCM/MAGIC/LEG11A/driver_SCM.py")
...
newcase.write('MAGIC_LEG11A_SCM_driver.nc')
