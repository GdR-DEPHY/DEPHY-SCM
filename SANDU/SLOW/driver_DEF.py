...
case.set_title("Forcing and initial conditions for SANDU composite slow transition case - Original definition")
case.set_reference("Sandu and Stevens (2011, JAS); Input file composite_slow_init.nc downloaded at http://gop.meteo.uni-koeln.de/~neggers/transitions/")
case.set_author("R. Roehrig")
case.set_script("DEPHY-SCM/SANDU/SLOW/driver_DEF.py")
case.set_comment("Use of file composite_slow_init.nc downloaded at http://gop.meteo.uni-koeln.de/~neggers/transitions/")

################################################
# 2. Input netCDF file
################################################

fin = nc.Dataset('composite_slow_init.nc','r')
