...
attributes = OrderedDict([
        ...
        ('nudging_constant_ua',     {'name': 'inversed nudging timescale for ua',      'units': 's-1'}),
        ('nudging_constant_va',     {'name': 'inversed nudging timescale for va',      'units': 's-1'}),
        ('nudging_constant_ta',     {'name': 'inversed nudging timescale for ta',      'units': 's-1'}),
        ('nudging_constant_theta',  {'name': 'inversed nudging timescale for theta',   'units': 's-1'}),
        ('nudging_constant_thetal', {'name': 'inversed nudging timescale for thetal',  'units': 's-1'}),
        ('nudging_constant_qv',     {'name': 'inversed nudging timescale for qv',      'units': 's-1'}),    
        ('nudging_constant_qt',     {'name': 'inversed nudging timescale for qt',      'units': 's-1'}),    
        ('nudging_constant_rv',     {'name': 'inversed nudging timescale for rv',      'units': 's-1'}),    
        ('nudging_constant_rt',     {'name': 'inversed nudging timescale for rt',      'units': 's-1'}),              
        # Surface forcing
