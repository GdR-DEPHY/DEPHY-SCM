...
## DYNAMO/NSA3Aflux_MJO1 case definition, with flux surface forcing
...
case.set_title("Forcing and initial conditions for DYNAMO/NSA3Aflux case - MJO event #1")
...
case.set_script("DEPHY-SCM/DYNAMO/NSA3Aflux_MJO1/driver_DEF.py")
...
sens = fin['sh'][nt0:nt1]/86400*2.5e6 # from mm day-1 to W m-2, Lv=2.5e6, 100 W m-2 = 3.45 mm day-1
lat = fin['eo'][nt0:nt1]/86400*2.5e6
case.add_surface_fluxes(sens=sens,lat=lat,time=timeForc,timeid='time',forc_wind='z0',z0=0.1)
...
case.write('DYNAMO_NSA3Aflux_MJO1_DEF_driver.nc')
