...
case.read('GABLS1_SIC_DEF_driver.nc')
...
newcase.set_title("Forcing and initial conditions for GABLS1/SIC case - SCM-enabled version")
...
newcase.write('GABLS1_SIC_SCM_driver.nc')
