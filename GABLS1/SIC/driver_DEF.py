...
case = Case('GABLS1/SIC',
        lat=80,
        lon=0,
        startDate="20000101000000",
        endDate="20000101110000",
        surfaceType='seaice',
        zorog=0.)

case.set_title("Forcing and initial conditions for a GABLS1 case with sea-ice")
...
t1 = 10*86400 # 17:00 UTC, 1 January 2000
...
case.write('GABLS1_SIC_DEF_driver.nc')
