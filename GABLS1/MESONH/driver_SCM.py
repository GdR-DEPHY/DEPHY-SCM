...
case.read('GABLS1_MESONH_DEF_driver.nc')
...
newcase.set_title("Forcing and initial conditions for GABLS1/MESONH case - SCM-enabled version")
...
newcase.write('GABLS1_MESONH_SCM_driver.nc',verbose=False)
