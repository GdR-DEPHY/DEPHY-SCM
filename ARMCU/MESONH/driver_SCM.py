...
case = utils.Case('ARMCU/MESONH')

# read case information in file
case.read('ARMCU_MESONH_DEF_driver.nc')
...
newcase.set_script("DEPHY-SCM/ARMCU/MESONH/driver_SCM.py")
...
newcase.write('ARMCU_MESONH_SCM_driver.nc',verbose=False)
