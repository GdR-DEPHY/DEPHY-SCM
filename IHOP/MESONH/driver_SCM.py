...
case = Case('IHOP/MESONH')

# read case information in file
case.read('IHOP_MESONH_DEF_driver.nc')
...
timeout = np.array(range(0,25200,1800),dtype=np.float64) 
...
newcase.set_title("Forcing and initial conditions for IHOP case - SCM-enabled Meso-NH version")
newcase.set_script("DEPHY-SCM/ARMCU/IHOP/driver_SCM.py")
...
newcase.write('IHOP_MESONH_SCM_driver.nc',verbose=False)
