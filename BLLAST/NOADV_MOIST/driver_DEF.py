...
case.set_title("Forcing and initial conditions for BLLAST case - Meso-NH definition with moister/warmer surface layer")
case.set_reference("Darbieu et al. (2015, ACP)")
case.set_author("F. Couvreux")
case.set_script("DEPHY-SCM/BLLAST/NOADV_MOIST/driver_DEF.py")
...
theta_new = theta + dtheta*np.where(1-z/hmax > 0, 1-z/hmax, 0)
case.add_init_theta(theta_new, lev=z, levtype='altitude')

# Water vapor mixing ratio
rv_new = rv + drv*np.where(1-z/hmax > 0, 1-z/hmax, 0)
rv_new = rv_new*0.001 # conversion g/kg en kg/kg

case.add_init_rv(rv_new, lev=z, levtype='altitude')
...
case.write('BLLAST_NOADV_MOIST_DEF_driver.nc')
