...
## BLLAST/REF SCM-enabled case definition
...
case.read('BLLAST_REF_DEF_driver.nc')
...
newcase.set_script("DEPHY-SCM/BLLAST/REF/driver_SCM.py")
...
newcase.write('BLLAST_REF_SCM_driver.nc')
