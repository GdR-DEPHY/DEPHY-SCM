...
case.read('LBA_OTHER_FLUX_DEF_driver.nc')

fin = nc.Dataset('LBA_OTHER_FLUX_DEF_driver.nc','r')
...
newcase.set_title("Forcing and initial conditions for LBA/OTHER_FLUX case - SCM-enabled version")
newcase.set_script("DEPHY-SCM/LBA/OTHER_FLUX/driver_SCM.py")
...
newcase.write('LBA_OTHER_FLUX_SCM_driver.nc')
