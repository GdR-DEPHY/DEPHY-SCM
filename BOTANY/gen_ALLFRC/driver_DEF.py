...
case.set_title("Forcing and initial conditions for BOTANY case - %s case ; 24h only, surf flux and rad tend forced"%scase)
...
# Fluxes and Z0
z0 = 0.001
tt, latent, sensible = np.genfromtxt('surface_flux_forcings.txt', dtype=float, skip_header=0, usecols=[0,1,2]).transpose()
case.add_surface_fluxes(sens=sensible, lat=latent, time=tt*3600, forc_wind='z0',z0=z0)
