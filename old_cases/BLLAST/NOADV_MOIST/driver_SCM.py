...
## BLLAST/NOADV SCM-enabled case definition
...
case.read('BLLAST_NOADV_MOIST_DEF_driver.nc')
...
newcase.set_script("DEPHY-SCM/BLLAST/NOADV_MOIST/driver_SCM.py")
...
newcase.write('BLLAST_NOADV_MOIST_SCM_driver.nc')
