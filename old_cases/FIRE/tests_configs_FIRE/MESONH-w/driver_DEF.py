...
Modifs :
  ...
  2025/03/01, N. Villefranque: 3 days instead of 37h
  2023/02/21, F. Couvreux: set-up MesoNH
"""
...
case.set_reference("Dyunkerke et al. (2004, QJRMS), Brient et al (2019,GRL)")
case.set_author("F. Couvreux")
case.set_script("DEPHY-SCM/FIRE/MESONH-w/driver_DEF.py")
case.set_modifications("Forcings modified in the upper levels - test with subsidence as REF")
...
zw = [0., 1200.]
w  = [-1.e-5*z for z in zw] # as in ref
...
case.write('FIRE_MESONH-w_DEF_driver.nc')
