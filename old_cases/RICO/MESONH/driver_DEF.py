...
## RICO case definition corresponding to MESONH LES setup
...
case.set_title("Forcing and initial conditions for RICO composite case - Meso-NH definition")
...
#case.set_comment("http://projects.knmi.nl/rico/setup1d_composite.html") # CE LIEN EST MORT
case.set_modifications("rv is initialized instead of qv; No surface scheme prescribed (only SST)")
...
# Specific humidity
zrv =[0.,     740.,     3260.,     4000.     ] 
rv = [0.01626,  0.01399,   0.00241,   0.00180] # converted in kg kg-1 
...
thadv  = [-2.89e-5, -2.89e-5, -2.89e-5, -2.89e-5] # converted in K s-1 
...
rvadv  = [-1.16e-8, 0.02e-8, 0.40e-8, 0.40e-8] # converted in kg kg-1 s-1
