...
## BOMEX case definition corresponding to MESONH LES setup
...
case.set_title("Forcing and initial conditions for BOMEX case - Meso-NH definition")
case.set_reference("Siebesma and Cuijpers (JAS, 1995), Grant and Brown (QJ, 1999)")
case.set_author("MP. Lefebvre")
case.set_script("DEPHY-SCM/BOMEX/MESONH/driver_DEF.py")
case.set_modifications("TKE is initialized to 0")
...
case.write('BOMEX_MESONH_DEF_driver.nc')
