...
case.read('ARMCU_MNHRADFRCSURF_DEF_driver.nc')
...
newcase.set_script("DEPHY-SCM/ARMCU/MNHRADFRCSURF/driver_SCM.py")
...
newcase.write('ARMCU_MNHRADFRCSURF_SCM_driver.nc')
