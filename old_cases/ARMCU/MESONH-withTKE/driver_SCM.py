...
case.read('ARMCU_MESONH-withTKE_DEF_driver.nc')
...
newcase.set_script("DEPHY-SCM/ARMCU/MESONH-withTKE/driver_SCM.py")
...
newcase.write('ARMCU_MESONH-withTKE_SCM_driver.nc')
